...
<head>
    ...
    <title>Dashboard Sistem Petugas Pengaduan</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Dashboard App</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Keterangan Status</h6>
                        <a class="collapse-item" href="{{ route('status.setuju') }}"><i class="fas fa-fw fa-check"></i>
                            Disitujui</a>
                        <a class="collapse-item" href="{{ route('status.tolak') }}"><i class="fas fa-fw fa-x"></i>
                            Ditolak</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-animation.html"><i class="fas fa-fw fa-user"></i>
                            User</a>
                        <a class="collapse-item" href="utilities-animation.html"><i class="fas fa-fw fa-user"></i>
                            Petugas</a>
                    </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <marquee behavior="scroll" direction="left">Sistem Layanan Pengaduan Masyarakat Berbasis Website
                    </marquee>
                    <!-- Topbar Navbar -->
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth('petugas')->user()->nama }}</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ URL::asset('administrator') }}/img/undraw_profile.svg">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">@yield('halaman')</h1>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">dengan memilih "Yakin" anda akan keluar dari Dashboard Sistem Pengaduan.</div>
